...
interface InventoryReturnModalProps {
    open: boolean;
    onClose: () => void;
    onSubmit: (returns: InventoryUsageItem[], notes: string) => Promise<void>;
    ticketId: string;
    loading?: boolean;
}

const InventoryReturnModal = ({ open, onClose, onSubmit, ticketId, loading = false }: InventoryReturnModalProps) => {
    ...
    const handleSubmit = async () => {
        ...
        if (selectedItems.length === 0) {
            showAlert({
                ...
                message: 'Please select at least one inventory item to return or add a note explaining why no inventory is being returned',
            });
            return;
        }

        const returns: InventoryUsageItem[] = selectedItems.map(item => ({
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        {inventories.length > 0 && (
                                            <div className="bg-white rounded-lg shadow-md p-6 mb-6 border border-gray-200">
                                                ...
                                                <div className="mt-4 flex justify-between items-center text-sm text-gray-600">
                                                    ...
                                                    <span className="text-purple-600">Available for return</span>
                                                </div>
                                            </div>
                                        )}
                                                ...
                                                <div className="flex">
                                                    ...
                                                    <div className="ml-3">
                                                        ...
                                                        <div className="mt-2 text-sm text-yellow-700">
                                                            <p>There are currently no inventory items in the system. You can still complete the ticket without returning inventory items.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        {inventories.length > 0 && (searchTerm || categoryFilter) && (
                                            <div className="bg-white rounded-lg shadow-md border border-gray-200 mb-6">
                                                <div className="px-6 py-4 border-b border-gray-200">
                                                    ...
                                                    <p className="text-sm text-gray-600 mt-1">Add items to your return list using the controls on the right</p>
                                                </div>
                                                                    ...
                                                                    <div className="flex items-center space-x-3 ml-4">
                                                                        {isSelected ? (
                                                                            ...
                                                                            <button
                                                                                ...
                                                                                className="px-3 py-1 text-xs text-purple-600 border border-purple-300 rounded hover:bg-purple-50 focus:outline-none focus:ring-2 focus:ring-purple-500"
                                                                            >
                                                                                Add to Return
                                                                            </button>
                                                                        )}
                                            ...
                                            <div className="bg-white rounded-lg shadow-md border border-gray-200 mb-6">
                                                <div className="px-6 py-4 border-b border-gray-200">
                                                    <div className="flex justify-between items-center">
                                                        <h4 className="text-lg font-semibold text-gray-900">Items to Return ({selectedItems.length})</h4>
                                                        <button
                                                                ...
                                                                <tr key={index} className="hover:bg-gray-50">
                                                                    ...
                                                                    <td className="px-6 py-4 whitespace-nowrap">
                                                                        <input
                                                                            ...
                                                                            className="w-16 px-2 py-1 text-sm border border-gray-300 rounded text-center focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
                                                                        />
                                                                    </td>
                                                ...
                                                <div className="px-6 py-4 border-t border-gray-200 bg-gray-50">
                                                    <label htmlFor="return-notes" className="block text-sm font-medium text-gray-700 mb-2">
                                                        Notes (Optional)
                                                    </label>
                                                    <textarea
                                                        id="return-notes"
                                                        ...
                                                        placeholder="Add notes for all returned items..."
                                                    />
                                                </div>
                                            </div>
                                        )}
                                        ...
                                        {selectedItems.length === 0 && inventories.length > 0 && (
                                            <div className="text-center py-8 text-gray-500">
                                                No items selected. Click on inventory items above to add them to your return list.
                                            </div>
                                        )}
                                        ...
                                        {inventories.length > 0 && !searchTerm && !categoryFilter && selectedItems.length === 0 && (
                                            <div className="text-center py-12 text-gray-500">
                                                ...
                                                <p className="text-sm text-purple-600">Start typing or select filters to browse available inventory</p>
                                            </div>
                                        )}
                                ...
                                <div className="flex justify-end space-x-3 mt-6">
                                    ...
                                    >
                                        {submitting || loading ? 'Processing...' :
                                         inventories.length === 0 ? 'Complete Ticket (No Inventory)' :
                                         'Complete Ticket and Return Items'}
                                    </button>
                                </div>
                            </Dialog.Panel>
                        </Transition.Child>
