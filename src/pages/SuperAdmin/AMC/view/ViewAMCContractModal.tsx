            ...
            if (response.status === 'success' || response.message.includes('successfully')) {
                if (localContract) {
                    ...
                    const updatedContract = {
                        ...localContract,
                        maintenances:
                            localContract.maintenances?.map((m) =>
                                m.id === maintenanceId
                                    ? {
                                          ...m,
                                        ...
                                        <>
                                            ...
                                            <div className="mb-6">
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span
                                                            className={`px-2 py-1 text-xs font-medium rounded-full ${localContract.is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}
                                                        >
                                            ...
                                            <div className="mb-6">
                                                ...
                                                {localContract.maintenances && localContract.maintenances.length > 0 ? (
                                                            ...
                                                            <tbody>
                                                                {localContract.maintenances.map((maintenance, index) => (
                                                                    <tr key={maintenance.id || index} className="bg-white border-b hover:bg-gray-50">
                                                                        <td className="px-4 py-3 font-medium text-gray-900">{maintenance.scheduled_date}</td>
                                                                        ...
                                                                        <td className="px-4 py-3">{maintenance.note || '-'}</td>
                                                                        <td className="px-4 py-3">
                                                                            <Listbox
                                                    ...
                                                    <div className="text-gray-500 text-center py-4 bg-gray-50 rounded-md">No maintenance schedule available</div>
                                                )}
                                            </div>
                                        </>
                                    )}
