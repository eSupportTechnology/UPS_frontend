...
const DeleteUserModal: React.FC<DeleteUserModalProps> = ({ open, onClose, onDelete, isDeleting, user }) => (
                ...
                <div className="flex min-h-full items-center justify-center px-4 py-8">
                    ...
                    >
                        <DialogPanel className="panel border-0 p-0 rounded-lg overflow-hidden w-full max-w-md text-black dark:text-white-dark">
                            ...
                            <div className="text-lg font-medium bg-[#fbfbfb] dark:bg-[#121c2c] pl-5 py-3 pr-[50px]">Delete User</div>
                            <div className="p-5">
                                <p>
