                        ...
                        <div className="relative p-8">
                            <div className="flex items-center mb-6">
                                <div className="relative">
                                    <div className="w-20 h-20 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center text-white text-2xl font-bold shadow-lg">N</div>
                                    <div className="absolute -bottom-1 -right-1 w-6 h-6 bg-green-500 rounded-full border-2 border-white dark:border-gray-800"></div>
                                </div>
                                <div className="ml-6">
                                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Navod Perera</h2>
                                    <p className="text-gray-600 dark:text-gray-400">Premium Customer</p>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center justify-between py-3 border-b border-gray-200/50 dark:border-gray-700/50">
                                    ...
                                    <span className="font-medium text-gray-900 dark:text-white">navod@example.com</span>
                                </div>
                                <div className="flex items-center justify-between py-3 border-b border-gray-200/50 dark:border-gray-700/50">
                                    <span className="text-gray-600 dark:text-gray-400">Phone:</span>
                                    <span className="font-medium text-gray-900 dark:text-white">+94 77 123 4567</span>
                                </div>
                                <div className="flex items-center justify-between py-3 border-b border-gray-200/50 dark:border-gray-700/50">
                                    <span className="text-gray-600 dark:text-gray-400">Customer Since:</span>
                                    <span className="font-medium text-gray-900 dark:text-white">January 2023</span>
                                </div>
                                <div className="flex items-center justify-between py-3 border-b border-gray-200/50 dark:border-gray-700/50">
                            ...
                            <button className="w-full mt-6 px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-semibold rounded-xl hover:from-blue-600 hover:to-blue-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105">
                                Update Profile
                            </button>
                        </div>
                    </div>
                        ...
                        <div className="group relative">
                            ...
                            <div className="relative p-6">
                                <div className="flex items-center mb-6">
                                    ...
                                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white ml-3">Support Tickets</h3>
                                </div>

                                <div className="grid grid-cols-2 gap-4">
                                    <div className="text-center p-4 rounded-xl bg-white/50 dark:bg-gray-700/50 backdrop-blur-sm">
                            ...
                            <div className="relative p-6">
                                <div className="text-center">
                                    <div className="flex items-center justify-center mb-4">
                                        <div className="p-3 rounded-xl bg-gradient-to-br from-green-400/20 to-green-600/20 backdrop-blur-sm mr-3">
                                        ...
                                        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Join Our WhatsApp Group</h3>
                                    </div>

                                    {/* QR Code Placeholder */}
                                    <div className="bg-white p-4 rounded-xl shadow-inner mx-auto w-fit mb-4">
                                    ...
                                    <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">Scan the QR code to join our WhatsApp support group for instant updates and assistance.</p>

                                    <button className="w-full px-4 py-2 bg-gradient-to-r from-green-500 to-green-600 text-white font-semibold rounded-lg hover:from-green-600 hover:to-green-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105">
