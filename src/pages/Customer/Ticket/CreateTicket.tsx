...
function CreateTicket() {
    ...
    return (
        <UserLayout>
            ...
            <div className="relative mb-12 sm:mb-16">
                <div className="absolute left-1/2 transform -translate-x-1/2 w-screen">
                    ...
                    <div className="relative text-center py-6 sm:py-8 px-4 sm:px-8">
                        <div className="mb-4">
                            <h1 className="text-2xl sm:text-4xl lg:text-6xl font-bold text-gray-900 dark:text-white mb-3 sm:mb-4">Create Ticket</h1>
            ...
            {/* Content Area */}
            <div className="w-full max-w-none space-y-4 sm:space-y-6 px-4 sm:px-6 lg:px-8">
                {/* Enhanced Create Ticket Form */}
                <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-lg sm:rounded-2xl shadow-2xl border border-white/20 dark:border-gray-700/30 p-4 sm:p-6 lg:p-8 mb-8">
                    {/* Form Progress Indicator */}
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 sm:mb-8 pb-4 sm:pb-6 border-b border-gray-200/50 dark:border-gray-700/50">
                        <div className="flex items-center space-x-3 sm:space-x-4 mb-4 sm:mb-0">
                            <div className="flex items-center justify-center w-7 h-7 sm:w-8 sm:h-8 bg-blue-500 text-white rounded-full text-xs sm:text-sm font-medium">1</div>
                            <div>
                                <h3 className="text-sm sm:text-base font-semibold text-gray-900 dark:text-white">Ticket Details</h3>
                                <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">Provide information about your issue</p>
                            </div>
                        </div>
                        <div className="hidden md:flex items-center space-x-2">
                            <div className="w-6 sm:w-8 h-1 bg-blue-500 rounded-full"></div>
                            <div className="w-6 sm:w-8 h-1 bg-gray-200 dark:bg-gray-600 rounded-full"></div>
                            <div className="w-6 sm:w-8 h-1 bg-gray-200 dark:bg-gray-600 rounded-full"></div>
                        </div>
                    </div>
