                        ...
                        <div className="bg-primary/5 dark:bg-primary/10 backdrop-blur-sm rounded-lg sm:rounded-2xl shadow-xl border border-primary/20 dark:border-primary/30 overflow-hidden">
                            <div className="bg-primary text-white p-4 sm:p-6">
                                <div className="flex items-center justify-between">
                                    ...
                                    <span className="text-xs px-2 py-1 bg-white/20 text-white rounded-full font-medium">Last 5</span>
                                </div>
                            </div>
                            ...
                            <div className="p-4 sm:p-6 space-y-3">
                                {loadingTickets ? (
                                    <div className="text-center py-4">
                                        ...
                                        <p className="text-xs text-gray-500 mt-2">Loading tickets...</p>
                                    </div>
                                ) : recentTickets.length > 0 ? (
                                    recentTickets.map((ticket) => (
                                        <div key={ticket.id} className="p-3 bg-gray-50/80 dark:bg-gray-700/50 rounded-lg border border-gray-200/50 dark:border-gray-600/50">
                                            <div className="flex items-center justify-between mb-2">
                                                <span className="text-sm font-medium text-gray-900 dark:text-white truncate max-w-[120px]">{ticket.title}</span>
                                    ...
                                    <div className="text-center py-4">
                                        <p className="text-sm text-gray-500 dark:text-gray-400">No recent tickets found</p>
                                    </div>
                                )}
                            </div>
                            ...
                            <div className="p-4 sm:p-6 space-y-4">
                                <div className="p-4 bg-primary/5 dark:bg-primary/10 rounded-lg border border-primary/20 dark:border-primary/30">
                                    <div className="flex items-center mb-2">
                                        ...
                                        <h4 className="font-medium text-primary-dark dark:text-primary-light">FAQ</h4>
                                    </div>
                                    <p className="text-sm text-primary dark:text-primary-light mb-3">Find quick answers to common questions</p>
                                    <button className="text-xs px-3 py-1.5 bg-primary text-white rounded-md hover:bg-primary-dark transition-colors">Browse FAQ</button>
                                </div>

                                <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200/50 dark:border-green-700/30">
                                    <div className="flex items-center mb-2">
                                ...
                                <div className="p-4 bg-primary/5 dark:bg-primary/10 rounded-lg border border-primary/20 dark:border-primary/30">
                                    <div className="flex items-center mb-2">
                                        ...
                                        <h4 className="font-medium text-primary-dark dark:text-primary-light">Phone Support</h4>
                                    </div>
                                    <p className="text-sm text-primary dark:text-primary-light mb-3">Call us directly for urgent matters</p>
                                    <div className="text-xs font-medium text-primary-dark dark:text-primary-light">07777 00 255</div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <form onSubmit={handleSubmitTicket} className="p-4 sm:p-6 lg:p-8 space-y-6 sm:space-y-8">
                                ...
                                <div className="space-y-3 sm:space-y-4">
                                    ...
                                    <div className="relative">
                                        ...
                                        <label
                                            htmlFor="photos"
                                            className="flex items-center justify-center w-full px-3 sm:px-4 py-4 sm:py-6 border-2 border-dashed border-gray-300/50 dark:border-gray-600/50 rounded-lg sm:rounded-xl hover:border-primary dark:hover:border-primary transition-colors cursor-pointer bg-white/50 dark:bg-gray-700/50 backdrop-blur-sm"
                                        >
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        <textarea
                                            ...
                                            onChange={handleInputChange}
                                            rows={4}
                                            className="w-full px-3 sm:px-4 py-3 sm:py-4 text-sm sm:text-base border border-gray-300/50 dark:border-gray-600/50 rounded-lg sm:rounded-xl shadow-sm focus:ring-2 focus:ring-primary/50 focus:border-primary/50 dark:bg-gray-700/50 dark:text-white transition-all duration-200 resize-vertical backdrop-blur-sm bg-white/50"
                                ...
                                <div className="flex justify-center sm:justify-end pt-4 sm:pt-6 border-t border-primary/20 dark:border-primary/30">
                                    <button
                                        type="submit"
                                        disabled={loading}
                                        className="w-full sm:w-auto group relative bg-primary hover:bg-primary-dark disabled:bg-gray-400 disabled:cursor-not-allowed text-white font-semibold py-3 sm:py-4 px-6 sm:px-10 text-sm sm:text-base rounded-lg sm:rounded-xl transition-all duration-200 focus:ring-2 focus:ring-primary focus:ring-offset-2 shadow-lg hover:shadow-xl transform hover:scale-105 disabled:hover:scale-100"
                                    >
                                        {loading ? (
